...
void* YoloObjectDetector::publishInThread() {
  ...
  if (num >= 0 && num <= 100) {
    ...
    for (int i = 0; i < numClasses_; i++) {
      // if (rosBoxCounter_[i] > 0 && classLabels_[i] == "sports ball") {
      // if (rosBoxCounter_[i] > 0 && classLabels_[i] == "sports ball") {
      // if (rosBoxCounter_[i] > 0 && (classLabels_[i] == "book" || classLabels_[i] == "sports ball")) {
      if (rosBoxCounter_[i] > 0 && classLabels_[i] == "book") {
